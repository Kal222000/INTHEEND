    ...
    public class UsuarioRepositorio : IUsuarioRepositorio
    {
        public DatosUsuarioDTO? ValidarUsuario(CredencialesDTO usuario)
        {
            ...
            using (var conexion = new SQLConexion())
            {
                ...
                conexion.Database.ExecuteSqlRawAsync("EXEC ValidarUsuario @CARNET, @CONTRASENA, @ID OUTPUT", Carnet,Contrasena, Salida);
        ...
        public bool CreacionCliente(NuevoUsuarioDTO usuario)
        {
            ...
            using (var conexion = new SQLConexion())
            {
                ...
                conexion.Database.ExecuteSqlRawAsync("EXEC CreacionCliente @NOMBRE, @APELLIDOP, @APELLIDOM, @FECHAN, @CARNET, @ROL, @CONTRASENA, @RESULTADO OUTPUT",
